...
A [timoni.sh](http://timoni.sh) module for deploying pipeline to Kubernetes clusters.
...
```shell
timoni -n default apply pipeline oci://<container-registry-url>
```
...
```shell
timoni -n default delete pipeline
```
